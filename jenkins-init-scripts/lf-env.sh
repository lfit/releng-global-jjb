...
# available to multiple scripts, provide a function that sets the variable:
# 'function lf_set_foo() {foo=asdf;}'. Any scripts that need access to the
# variable can call the 'set' function. This keeps the name-space polution to a
# minimum.
