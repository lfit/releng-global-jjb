...
#
# NAME
#   lf-activate-venv [-p|--python python] package [package]...
#
# SYNOPSIS
#   # shellcheck disable=SC1090
#   source ~/lf-env.sh
...
#   or
#   lf-activate-venv jenkins-job-build
#   or
#   lf-activate-venv lftools
#   or
#   lf-activate-venv git-review --python python2
#
# DESCRIPTION
#
#   This function will create a new Python Virtual Environment (venv).  The bin
#   directory from the venv will prepended to the PATH.
#
