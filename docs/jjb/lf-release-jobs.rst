...
:Required parameters:
    ...
    :jenkins-ssh-credential: Credential to use for SSH. (Generally set
        in defaults.yaml)
    :stream: we only run this job against: master
...
:Template Name:
    - lf-release-job-verify

Release Verify
------------------

Verify job which checks schema and ensures with can grab the staging-repo.txt.gz
