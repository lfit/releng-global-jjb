...
variable NEXUS3_PULL_REGISTRY. The new image should be pushed to the
registry in the environment variable NEXUS3_PUSH_REGISTRY.
...
the environment variable NEXUS3_PULL_REGISTRY.
