...
required format of the release yaml file appears in schemas and
examples below. The version must be a valid Semantic Versioning
(SemVer) string, matching either the pattern "v#.#.#" or "#.#.#"
where "#" is a one or more digits.
