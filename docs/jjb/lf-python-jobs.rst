...
runs the coverage command to gather tests results. These test results are
reflected back into Sonar after running the Sonar goals.

:Template Names:

    - {project-name}-tox-sonar
    - gerrit-python-tox-sonar
    - github-python-tox-sonar
