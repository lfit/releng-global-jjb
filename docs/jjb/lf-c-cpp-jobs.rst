...
The following example defines a simple CMake-Sonarcloud job that depends on
configuration parameters in the umbrella project's defaults.yaml file.
...
.. code-block:: yaml
    ...
    - project:
        ...
        sonar-properties: |
            ...
            sonar.cfamily.gcov.reportsPath=subdir-name
        jobs:
          - gerrit-cmake-sonarcloud
