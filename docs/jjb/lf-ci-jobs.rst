...
OpenStack Cloud plugin version supported: 2.30
...
:Cloud Parameters:
    ...
    :INSTANCE_CAP: Total number of instances the cloud will allow spin up.
        (default: null)
    :INSTANCE_CAP_SANDBOX: Total number of instances the clodu will allow to
        spin up. This applies to "sandbox" systems. (default: null)
...
:Template Parameters:
    ...
    :INSTANCE_CAP_SANDBOX: Total number of instances of this type that can be launched
        at one time. When defined in clouds.cfg it defines the total for the
        entire cloud. This applies to "sandbox" systems. (default: null)
