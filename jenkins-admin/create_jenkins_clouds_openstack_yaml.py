...
#cfg files are not reall ini files, need to add a header.
...
#yeah.. this path will probably need to be fixed.
for filename in glob.iglob('../../jenkins-config/**/*.cfg', recursive=True):
