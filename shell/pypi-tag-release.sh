...
verify_schema(){
    ...
    wget 'https://gerrit.linuxfoundation.org/infra/gitweb?p=releng/global-jjb.git;a=blob_plain;f=schema/release-pypi-schema.yaml;hb=refs/changes/32/16632/33' -O ${pypi_schema}
