...
# Clone global-jjb to get access to needed scripts
git clone -q https://github.com/lfit/releng-global-jjb.git /tmp/releng-global-jjb
...
for release_file in $release_files; do
    ...
    lftools schema verify $release_file /tmp/releng-global-jjb/schema/release-schema.yaml
