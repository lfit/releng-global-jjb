...
#overwrite release files for testing
...
#zxiiro [2:53 PM]
#@aric jenkins doesn't currently sign. it's not something we sovled yet
#@aric we'll need to figure out how to make sigul do it someday though

echo "tag -asm "$PROJECT $VERSION" "v$VERSION""
