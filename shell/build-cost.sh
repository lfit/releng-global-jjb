...
# Get the Cost of the Openstack builders. The 'stack-cost' file is created by
# 'openstack-stack-cost.py' which is called by 'openstack-stack-delete.sh',
# before that script deletes the stack.
...
# Bash readable
cat << EOF > $WORKSPACE/archives/cost/cost.sh.txt
#!/usr/bin/no-execute
