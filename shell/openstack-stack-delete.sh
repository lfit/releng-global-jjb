...
echo "Retrieving stack cost for: $OS_STACK_NAME"
# The build may not create a global-jjb clone, so we need to run this script
# from the clone created by Jenkins Init Scripts (/opt/ciman).
